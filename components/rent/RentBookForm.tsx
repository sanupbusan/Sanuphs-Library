    ...
    <div className="mx-auto max-w-2xl">
      ...
      <form onSubmit={handleStudentSubmit} className="mb-4 rounded-lg border border-gray-100 bg-white p-5 shadow-sm">
        ...
        <div className="flex gap-2">
          ...
          <button
            className="inline-flex h-11 shrink-0 whitespace-nowrap items-center justify-center rounded-lg bg-primary-600 px-4 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-primary-700 disabled:cursor-wait disabled:opacity-70"
        ...
        {student ? (
          <div className="mt-4 rounded-lg bg-green-50 p-3">
            <div className="flex items-center justify-between gap-3">
              ...
              <button
                className="shrink-0 whitespace-nowrap rounded-md px-2 py-1 text-xs font-semibold text-green-700 transition-colors hover:bg-green-100"
